...
public class Player : ICreature
{
    ...
    /* TODO:  Write Behaviors that allow the player to equip and unequip things things
              i.e. move something from your inventory to equipment [Moderate]
                   make sure items aren't lost when equipping a new item [Easy]
                   when an item is unequipped, it should return to the players inventory [Easy]
     */

    private Dictionary<UniqueName, ICarryable> _inventory = new();
    public ReadOnlyDictionary<UniqueName, ICarryable> Items => _inventory.AsReadOnly();
